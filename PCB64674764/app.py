...
##    image_path = 'static/test/'+image
##    
##    # Process the image
##    grayscale_path, edges_path = process_image(image_path)
##    
##    
##    # Render the HTML page with processed images
##    return render_template('userlog.html', grayscale_path=grayscale_path, edges_path=edges_path)
